      ...
      <div className="space-y-5">
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            Join Ping-Me and start real-time conversations today
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
          <div>
            ...
            <div className="relative">
              <User className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--icon-muted)]" />
              <input
                {...register('name')}
                type="text"
                placeholder="John Doe"
                className="w-full pl-10 pr-4 py-2 rounded-xl glass-input text-sm text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] transition-all"
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              <AtSign className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--icon-muted)]" />
              <input
                {...register('username')}
                type="text"
                placeholder="johndoe"
            ...
            {errors.username && <p className="text-xs text-red-500 dark:text-red-400 mt-1">{errors.username.message}</p>}
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-2.5 px-4 rounded-xl btn-primary font-medium text-sm flex items-center justify-center gap-2 shadow-xs cursor-pointer mt-1 disabled:opacity-50"
          >
        ...
        <p className="text-xs text-center text-[var(--text-secondary)] pt-1">
          ...
          <Link href="/login" className="text-[var(--text-primary)] font-semibold hover:underline transition-all">
            Sign in
          </Link>
        </p>
      </div>
